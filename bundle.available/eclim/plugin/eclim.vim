...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/daniel/.eclipse/org.eclipse.platform_4.2.0_1543616141/plugins/org.eclim_2.2.5'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/daniel/.eclipse/org.eclipse.platform_4.2.0_1543616141'
  if has('win32unix')
